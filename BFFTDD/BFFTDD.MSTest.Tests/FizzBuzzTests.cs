...
namespace BFFTDD.MSTest.Tests
{
    [TestClass]
    public class FizzBuzzTests
    {
        private FizzBuzzController _testObject;
        private Mock<IGameLogger> _logger;
        ...
        [DataRow(15, "FizzBuzz")]
        //Sad Path
        //[DataRow(101, null)] - This will not pass since MSTest doesn't like null here
        ...
        public void Play_Logs_Each_Game()
        {
            ...
            //Assert
            Assert.IsNotNull(gameResultCallback);
            Assert.AreEqual(expectedNumber, gameResultCallback.Number);
            Assert.AreEqual(expectedOutcome, gameResultCallback.Outcome);
        ...
        public void Play_Throws_Exception_If_LogGame_Fails()
        {
            ...
            //Act
            var ex = Assert.ThrowsException<Exception>(() => _testObject.Play(5));

            //Assert
            Assert.IsNotNull(ex);
            Assert.AreEqual("Something went wrong with logging the game", ex.Message);
